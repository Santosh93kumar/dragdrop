      ...
      <section className="">
        <nav className="w-full flex py-3 items-center">
          ...
          <div className="w-5/12 hidden md:flex flex-end">
            <ul className="list-none flex space-x-6 font-semibold rounded-lg  text-base lg:text-lg border-gray-200 px-3 lg:px-5 py-1 lg:py-2 cursor-pointer">
          ...
          <div className="md:hidden flex ml-auto mr-4 text-white">
            <div>
              {click ? (
        ...
        <div
          className={`fixed top-0 right-0 w-64 h-full bg-purple-900 text-white shadow-lg transform ${
        ...
        >
          ...
          {/* Sidebar Links */}
          <ul className="list-none mt-12 flex flex-col space-y-4 p-6">
            <li className="text-gray-300 hover:text-white cursor-pointer">Product</li>
            <li className="text-gray-300 hover:text-white cursor-pointer">Pricing</li>
            <li className="text-gray-300 hover:text-white cursor-pointer">Company</li>
            <li className="text-gray-300 hover:text-white cursor-pointer">Blog</li>
            <li className="text-gray-300 hover:text-white cursor-pointer">Changing</li>
          </ul>
        </div>
      </section>
    </>
